...
%	\end{figure}
	...
	\begin{figure}[H]
	\centering
	\subfigure[New York Market. Price per ounce. 1790-2017]{\includegraphics[width=0.75\linewidth]{oro_en.PNG}
		\label{fig:oro_us}}
	\subfigure[London Market. British pounds per ounce. 1700-1900]{\includegraphics[width=0.75\linewidth]{oro_uk.PNG}
		\label{fig:oro_uk}}
...
\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfigure[US GDP. Millions of ounces of gold, 1900-2017]{\includegraphics[width=0.75\linewidth]{gdp_in_gold_eda_en.PNG}
			\label{fig:PBI}}
		\subfigure[US Hourly Wage. Ounces of gold, 1900-2017]{\includegraphics[width=0.75\linewidth]{wg_in_gold_eda_en.PNG}
			\label{fig:salario}}
	...
	\begin{figure}[H]
		\centering
		\subfigure[US GDP. Millions of ounces of gold]{\includegraphics[width=0.75\linewidth]{gdp_us_complement.PNG}
			\label{fig:PBI_us_comp}}
		\subfigure[US Hourly Wage. Ounces of gold]{\includegraphics[width=0.75\linewidth]{wage_us_complement.PNG}
	...
	\begin{figure}[H]
		\centering
		\subfigure[US GDP spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_gdp_en.png}
			\label{fig:espect_PBI_a}}
		\subfigure[US log(GDP) spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_log_gdp_en.png}
...
%	\begin{figure}[H]
%		\centering
%		\subfigure[Wage spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_wg_en.png}
%			\label{fig:espect_wg_a}}
%		\subfigure[log(wage) spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_log_wg_en.png}
...
%	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfigure[UK GDP spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_gdp_uk_en.png}
			\label{fig:espect_uk_a}}
		\subfigure[UK log(GDP) spectrogram]{\includegraphics[width=0.75\linewidth]{espectograma_log_gdp_uk_en.png}
	...
	\begin{figure}[H]
		\centering
		\subfigure[UK GDP. Millions of ounces of gold, 1700-1900. Trend]{\includegraphics[width=0.75\linewidth]{pbi_uk_tendencias_en.png}
			\label{fig:tendencias}}
		\subfigure[UK GDP spectrogram, trend]{\includegraphics[width=0.48\linewidth]{espectograma_gdp_uk_Tend_en.png}
			\label{fig:espectograma_gdp_uk_Tend}}
		\subfigure[UK GDP spectrogram, detrended]{\includegraphics[width=0.48\linewidth]{espectograma_gdp_uk_sinTend_en.png}
