...
df %>%
  ...
  geom_line()+
  labs(y='value',title= "Elements of theoretical series")+
  facet_wrap(~componente, scales="free")+
  theme_minimal()
...
ggplot(uk_gdp_filt, aes(x=date ))+
  ...
  theme_minimal()+
  labs(x="", y="GDP in gold", title= "UK GDP",
       subtitle= "Millions of ounces of gold, 1700-1900. Trend")+
  theme(text = element_text(size = 20),
        legend.position = "bottom",
        legend.title = element_blank())
...
wt.image(gdp_wavelet,color.key = "q",
         ...
         plot.legend = FALSE,
         label.time.axis = TRUE,
         main = "UK GDP spectrogram, detrended")
dev.off()
```
